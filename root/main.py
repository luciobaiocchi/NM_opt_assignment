...
print(f"DONE. Tempo impiegato (Truncated): {execution_time_tn_banded:.4f} secondi")
print("="*50)

analyze_convergence(hist_tn_banded)
plot_convergence(hist_tn_banded, "Truncated Newton") # Decommenta se vuoi il grafico
...
print(f"DONE. Tempo impiegato (Modified) per Banded Trigonometric: {execution_time_mn_banded:.4f} secondi")
print("="*50)

analyze_convergence(hist_mn_banded)
plot_convergence(hist_mn_banded, "Modified Newton Banded Trigonometric") # Decommenta se vuoi il grafico
